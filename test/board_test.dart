...
void main() {
  ...
  */
  ...
  |  |  |  |  |  |  |  |  |
  */
  test("isSWValid occupied", () {
    Board b = new Board();
    expect(b.isSWValid(Move.d4, Disc.Black), false);
  });
  ...
  |  |  |  |  |  |  |  |  |
  */
  test("isSWValid empty", () {
    Board b = new Board();
    expect(b.isSWValid(Move.b2, Disc.Black), false);
  });
  ...
  */
  test("isSWValid side", () {
    Board b = new Board();
    expect(b.isSWValid(Move.c8, Disc.Black), false);
  });
  ...
  */
  test("isSWValid valid", () {
    ...
    expect(b.isSWValid(Move.f4, Disc.Black), true);
  });
  ...
  |  |  |  |  |  |  |  |  |
  */
  test("isSWValid invalid", () {
    Board b = new Board();
    
    b[Move.d5] = Disc.White;
    b[Move.d6] = Disc.White;
    
    expect(b.isSWValid(Move.f4, Disc.Black), false);
  });
}
